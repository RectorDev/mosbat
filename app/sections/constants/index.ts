...
const TEAM_SECTION = {
  ...
  members: [
    {
      pfp: "/team/person-1.png",
      name: "John Smith",
      role: "CEO and Founder",
      experience: "10+ years of experience in digital marketing",
      expertise: "Expertise in SEO, PPC, and content strategy",
    },
    {
      pfp: "/team/person-2.png",
      name: "Jane Doe",
      role: "Director of Operations",
      experience: "7+ years of experience in project management and team leadership",
      expertise: "Strong organizational and communication skills",
    },
    {
      pfp: "/team/person-3.png",
      name: "Michael Brown",
      role: "Senior SEO Specialist",
      experience: "5+ years of experience in SEO and content creation",
      expertise: "Proficient in keyword research and on-page optimization",
    },
    {
      pfp: "/team/person-4.png",
      name: "Emily Johnson",
      role: "PPC Manager",
      experience: "3+ years of experience in paid search advertising",
      expertise: "Skilled in campaign management and performance analysis",
    },
    {
      pfp: "/team/person-5.png",
      name: "Brian Williams",
      role: "Social Media Specialist",
      experience: "4+ years of experience in social media marketing",
      expertise: "Proficient in creating and scheduling content, analyzing metrics, and building engagement",
    },
    {
      pfp: "/team/person-6.png",
      name: "Sarah Kim",
      role: "Content Creator",
      experience: "2+ years of experience in writing and editing",
      expertise: "Skilled in creating compelling, SEO-optimized content for various industries",
    },
  ],
};
...
export { CONTACT_US_SECTION ,HERO_SECTION, CASE_STUDIES_SECTION, SERVICES_SECTION, WORKING_PROCESS_SECTION, TEAM_SECTION, TESTIMONIALS_SECTION };
