...
export default function Hero() {
  return (
    <section className="container-padding ">
     <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-20 mt-[50px] ">
        ...
        <div className="hidden flex-1  lg:flex">
          <Image className="h-auto w-auto object-contain" alt="hero image" src={"/hero-img.png"} width={500} height={500} />
        </div>
     </div>
      <SliderCompa/>
    </section>
